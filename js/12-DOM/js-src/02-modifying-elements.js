...
///////////////////////////////////////// Changing value of attribues/////////////////////////////
// access the object first ('img') use dot to access the property of the object ("img").scr  = new value. This process creates the scr as a property of img object 

document.querySelector("img").src = "./images/img2.png"
...
// document.querySelector(".list").style.borderTop = "3px solid red";
// document.querySelector(".list").style.borderBottom = "3px solid red";


//////////////////////////////Adding & Removing Cklasses//////////////////////////////////
//remnovong class usong
//classList method
